			...
			<div class="box box-primary">
				...
				<div class="box-body" id="searchDiv">
					<select name="searchType">
						...
						<option value="c" ${cri.searchType=='c'? 'selected':'' }>category</option>
					</select>
				...
				<div class="table-responsive"><!--  class="box-body" -->
					<table class="table" >
						<tr>
							...
							<th>주제</th>
							<th class="buctest">BucketList[댓글]</th>
							<th class="buctest">등록시간</th>
							<th>조회수</th>
							<th>작성자</th>
						</tr>
						...
						<c:forEach var="board" items="${list }">
							<tr>
								<td style="width:30px;">${board.bno }</td>
								<td>${board.category }</td>
								<td>
								<a href="read${pageMaker.makeSearch(cri.page) }&bno=${board.bno }&fromlist=true" style="color:black; font-weight:bold;" title="상세보기">${board.title }</a>[${board.replyCnt }]</td>														
